...
public class FileCameraConfigurationWizard extends ReferenceCameraConfigurationWizard {
    private final FileCamera camera;
    ...
    public FileCameraConfigurationWizard(FileCamera camera) {
        super(camera);
