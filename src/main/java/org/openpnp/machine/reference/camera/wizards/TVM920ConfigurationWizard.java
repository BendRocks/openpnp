...
import org.openpnp.machine.reference.camera.TVM920Camera;
...
public class TVM920ConfigurationWizard extends ReferenceCameraConfigurationWizard {
    private final TVM920Camera camera;
    ...
    public TVM920ConfigurationWizard(TVM920Camera camera) {
        super(camera);
